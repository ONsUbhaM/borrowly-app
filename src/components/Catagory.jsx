    ...
    <div className="mt-70 md:mt-20 ">
      ...
      <div className="grid place-items-center grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-9 gap-6 px-20">
        {Data.Catagory.map((cat) => (
          <Link to={"search/" + cat.name} key={cat.id}>
            <div className="border rounded-md p-3 items-center flex flex-col hover:bg-purple-500 hover:scale-105 hover:shadow-lg transition-all duration-300 cursor-pointer">
